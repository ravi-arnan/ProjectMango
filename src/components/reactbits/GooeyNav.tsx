...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  return (
    <>
      ...
      <div className="relative gn-root" ref={containerRef}>
        <nav className="flex relative" style={{ transform: 'translate3d(0,0,0.01px)' }}>
          <ul
            ref={navRef}
            className="flex gap-2 list-none p-0 m-0 relative z-[3] font-headline font-medium text-sm tracking-tight"
            style={{ color: '#1f1b17' }}
          >
